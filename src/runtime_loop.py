...
# v4.5.0 §0.5 — controls visual_enabled, model overrides
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Null stubs for disabled features (visual_enabled=False)
# ---------------------------------------------------------------------------
...
async def run_voice_loop(
    ...
    if _HAS_TRANSCRIPT:
        ...
        _transcript = None
    logger.info("Live2DServer: initializing (always enabled)")
